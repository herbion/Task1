...
//    }
    ...
    private Map<Long, Raise> raiseDataBase = new Hashtable<Long, Raise>();
    ...
    public Collection<Raise> getRaiseDataBase() {
	return raiseDataBase.values();
    }
    ...
    public void setRaiseDataBase(Map<Long, Raise> raiseDataBase) {
	nullCheck(raiseDataBase, "Raises cannot be null");
	this.raiseDataBase = raiseDataBase;
    }
}
